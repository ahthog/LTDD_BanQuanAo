...
public class SearchFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        searchAdapter = new ProductAdapter(getContext(), new ArrayList<>()); // Adapter cho kết quả tìm kiếm
    ...
    private void searchProduct() {
        ...
        searchAdapter = new ProductAdapter(getContext(), filteredProducts);
        recyclerViewSearch.setAdapter(searchAdapter);
    ...
    // Phương thức để nhận danh sách sản phẩm từ bên ngoài
    public void setProducts(List<Product> products) {
        this.products = products; // Nhận danh sách sản phẩm
        if (searchAdapter != null) {
            searchAdapter = new ProductAdapter(getContext(), this.products); // Cập nhật adapter với danh sách mới
            recyclerViewSearch.setAdapter(searchAdapter);
        }
    }
}
